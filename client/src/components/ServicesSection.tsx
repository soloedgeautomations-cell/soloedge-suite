...
import { Phone, Calendar, Mail, Globe, X } from "lucide-react";
import SectionBackground from "@/components/SectionBackground";

const ICONS = [Phone, Calendar, Mail, Globe];
const COLORS = [
...
const SERVICE_DETAILS = [
  {
    title: "SoloHub",
    bullets: [
      "Answers every inbound call 24/7 in English or Spanish.",
      "Qualifies the caller, captures name, number, and reason for calling.",
      "Sends you an instant Telegram or text summary after every call.",
      "Handles FAQs, hours, pricing, and directions automatically.",
      "Escalates urgent calls to you immediately via Telegram alert.",
      "Responds to new leads within seconds so they don't call a competitor first.",
    ],
  },
  {
    title: "SoloBooking",
    bullets: [
      "Books appointments directly into your Google Calendar in real time.",
      ...
      "Syncs with your existing calendar. No double-bookings.",
    ],
  },
  {
    title: "EdgeMail",
    bullets: [
      "Surfaces what matters in your inbox. Drafts what's routine.",
      "Estimates, confirmations, follow-ups all drafted for one-click send.",
      ...
      "Saves most owners 1 to 2 hours a day on email alone.",
    ],
  },
  {
    title: "LiveDesk",
    bullets: [
      "Real-time English, Spanish, and Chinese live meeting translation.",
      "Works on job sites, front desks, and client meetings.",
      "No app to download. Works via your existing phone.",
