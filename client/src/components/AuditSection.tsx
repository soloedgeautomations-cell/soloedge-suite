...
const AUDIT_TIERS = [
  {
    ...
    bullets: [
      ...
      "Multilingual customer-loss estimate (revenue your phone is losing right now)",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Multilingual customer-loss estimate",
      "Audit fee credits 100% toward your install if signed within 30 days*",
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Multilingual customer-loss estimate + multilingual workflow review across all customer touchpoints",
