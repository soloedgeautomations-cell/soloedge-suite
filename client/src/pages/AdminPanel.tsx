      ...
      <div className="border-b border-gray-200 bg-white/95 backdrop-blur-xl sticky top-0 z-40 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={CDN.logoTransparent} alt="SoloEdge AI" className="h-9 w-auto object-contain" />
        ...
        {activeTab === "provision" && (
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div className="mb-5 p-4 bg-amber-50 border border-amber-200 rounded-xl">
              <p className="text-xs font-semibold text-amber-800 mb-2">🔧 Link Existing Number (+15123991605)</p>
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    const r = await linkExistingPhone.mutateAsync({ phoneNumber: "+15123991605" });
              ...
              >
                {linkExistingPhone.isPending ? "Linking..." : "Link +15123991605 to Riley Now"}
              </button>
            </div>
