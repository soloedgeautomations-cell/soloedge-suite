...
const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      ...
      subtext: "SoloCommand is the AI Operating System I build for small business. It runs on a small box that sits in your shop, answers your phone in English and Spanish, books your appointments, drafts your routine emails, and writes to the Google Sheets and Calendar you already use. I sit down with you for 90 minutes first. I write you a plan. We build only what you need.",
      cta: "See Pricing →",
      ...
      responses: {
        calls: "Tess picks up when you can't. She qualifies the caller, captures the lead, sends you a text. You stay on the job.",
        ...
        appointments: "Tess handles the back-and-forth, confirms the time, sends reminders. Your calendar fills without you managing it.",
  ...
  es: {
    ...
    hero: {
      ...
      responses: {
        calls: "Tess contesta cuando no puedes. Califica al cliente, captura el prospecto, te manda un mensaje. Tú te quedas enfocado en el trabajo.",
        ...
        appointments: "Tess maneja la conversación, confirma el horario, manda recordatorios. Tu agenda se llena sin que tengas que administrarla.",
  ...
  zh: {
    ...
    hero: {
      ...
      subtext: "SoloCommand 是我为小企业打造的 AI 操作系统。它运行在放在您店里的小盒子上，用英语和西班牙语接听电话，预约时间，起草日常邮件，并写入您已经在使用的 Google 表格和日历。我先和您坐下来 90 分钟，给您写一份计划，我们只构建您需要的部分。",
      cta: "查看价格 →",
      ctaSecondary: "开始使用",
      ...
      responses: {
        calls: "您无法接听时 Tess 会代为接听。她筛选来电、记录客户信息、给您发短信。您专注于工作本身。",
        language: "英语、西班牙语和中文覆盖电话、短信、现场记录和客户更新。您的团队和客户始终保持同步。",
        appointments: "Tess 处理预约沟通、确认时间、发送提醒。日历自动填满，无需您手动管理。",
